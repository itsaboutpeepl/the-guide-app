...
import '../../models/articles/blogArticle.dart' as _i39;
...
class RootRouter extends _i1.RootStackRouter {
  ...
  final Map<String, _i1.PageFactory> pagesMap = {
    ...
    NewsHomeTab.name: (routeData) => _i1.MaterialPageX<dynamic>(
        routeData: routeData,
        builder: (_) {
          return const _i1.EmptyRouterPage();
        }),
    ...
    NewsHomeScreen.name: (routeData) => _i1.MaterialPageX<dynamic>(
        routeData: routeData,
        builder: (_) {
          return _i16.NewsScreen();
        }),
  ...
  List<_i1.RouteConfig> get routes => [
        ...
        _i1.RouteConfig(MainScreen.name, path: '/main-screen', guards: [
          ...
          _i1.RouteConfig(NewsHomeTab.name, path: 'newsHome', children: [
            _i1.RouteConfig(NewsHomeScreen.name, path: '', guards: [authGuard]),
            _i1.RouteConfig(DetailBlogArticle.name,
                path: 'detail-blog-article', guards: [authGuard])
          ]),
...
class NewsHomeTab extends _i1.PageRouteInfo {
  const NewsHomeTab({List<_i1.PageRouteInfo>? children})
      : super(name, path: 'newsHome', initialChildren: children);
...
class DetailBlogArticle extends _i1.PageRouteInfo<DetailBlogArticleArgs> {
  DetailBlogArticle({_i2.Key? key, required _i39.BlogArticle blogArticle})
      : super(name,
...
class DetailBlogArticleArgs {
  ...
  final _i39.BlogArticle blogArticle;
}

class NewsHomeScreen extends _i1.PageRouteInfo {
  const NewsHomeScreen() : super(name, path: '');
