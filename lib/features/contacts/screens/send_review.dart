...
import 'package:guide_liverpool/redux/viewsmodels/send_amount.dart';
...
class _SendReviewScreenState extends State<SendReviewScreen> with TickerProviderStateMixin {
                                  ...
                                  Column(
                                    ...
                                    children: args.name != null
                                        ? <Widget>[
                                            ...
                                            args.phoneNumber == null || args.phoneNumber!.isEmpty
                                                ? SizedBox.shrink()
                                                : Text(
                                                    args.phoneNumber!,
                                ...
                                ? Padding(
                                    ...
                                    child: Text(
                                      I10n.of(context).invite_text(
                                        args.name != null ? args.name! : I10n.of(context).friend,
                                      ),
                                      textAlign: TextAlign.center,
                                      style: TextStyle(
                                        fontSize: 14,
