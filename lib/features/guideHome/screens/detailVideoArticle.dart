...
class DetailVideoArticle extends StatefulWidget {
  const DetailVideoArticle({Key? key}) : super(key: key);

  @override
  State<DetailVideoArticle> createState() => _DetailVideoArticleState();
}
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            Text(
              "Lorem ipsum dolor sit amet, con se ctetur adipiscing elit assa",
