...
NetworkTabState _$NetworkTabStateFromJson(Map<String, dynamic> json) {
  return _NetworkTabState.fromJson(json);
}

/// @nodoc
mixin _$NetworkTabState {
  @JsonKey(ignore: true)
  ...
  @JsonKey(ignore: true)
  $NetworkTabStateCopyWith<NetworkTabState> get copyWith =>
...
/// @nodoc
abstract class _$$_NetworkTabStateCopyWith<$Res>
    implements $NetworkTabStateCopyWith<$Res> {
  factory _$$_NetworkTabStateCopyWith(
...
@JsonSerializable()
class _$_NetworkTabState extends _NetworkTabState {
  _$_NetworkTabState(
  ...
  factory _$_NetworkTabState.fromJson(Map<String, dynamic> json) =>
      _$$_NetworkTabStateFromJson(json);
  ...
  Map<String, dynamic> toJson() {
    return _$$_NetworkTabStateToJson(
      this,
    );
  }
}
